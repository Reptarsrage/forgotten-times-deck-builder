    ...
    <div className="flex flex-1 gap-4">
      ...
      <div className="flex flex-1 flex-col gap-2">
        <div className="flex flex-col">
          <label>Name</label>
          <input type="text" value={name} name="name" onChange={onNameChange} className="pl-1 dark:bg-slate-950" />
        </div>

        <div className="flex flex-col">
          <label>Text</label>
          <textarea value={text} name="text" onChange={onTextChange} className="pl-1 dark:bg-slate-950" />
        </div>

        <div className="flex flex-col">
          <label>Subtype</label>
          <input value={subtype} name="subtype" onChange={onSubTypeChange} className="pl-1 dark:bg-slate-950" />
        </div>

        <div className="flex gap-8">
          <div className="flex flex-col">
            <label>Type</label>
            <select value={type ?? ''} name="type" onChange={onTypeChange} className="w-32 pl-1  dark:bg-slate-950">
          ...
          <div className="flex flex-col">
            ...
            <select value={devotion ?? ''} name="devotion" onChange={onDevotionChange} className="w-32 pl-1  dark:bg-slate-950">
              <option value="" hidden></option>
        ...
        <div className="flex gap-8">
          <div className="flex flex-col">
            <label>Cost</label>
            <input type="number" value={cost ?? ''} name="cost" onChange={onCostChange} className="w-32 pl-1  dark:bg-slate-950" />
          </div>

          <div className="flex flex-col">
            <label>Power</label>
            <input type="number" value={power ?? ''} name="power" onChange={onPowerChange} className="w-32 pl-1  dark:bg-slate-950" />
          </div>

          <div className="flex flex-col">
            <label>Health</label>
            <input type="number" value={health ?? ''} name="health" onChange={onHealthChange} className="w-32 pl-1  dark:bg-slate-950" />
          </div>
        </div>
        ...
        <div className="flex gap-8">
          <div className="flex flex-col">
            ...
            <input
              ...
              className="w-32 pl-1  dark:bg-slate-950"
            />
          </div>
